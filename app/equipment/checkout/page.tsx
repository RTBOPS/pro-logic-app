  ...
  const save = async () => {
    ...
    try {
      await addDoc(collection(db, 'users', uid, 'equipment_checkout'), {
        ...
        remarks, issuedBy, receivedBy, createdAt: new Date().toISOString(),
      });
      setSaved(true);
    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="space-y-6 mt-4">
        ...
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <h2 className="font-bold text-gray-800 mt-6 mb-4 text-sm uppercase tracking-wide">Signatures</h2>
