...
import {
  ...
  ListOrdered, Shield, Tv, MonitorPlay, ChevronLeft, ChevronRight, Wallet, FileCheck, Brush, Sunrise, Aperture, Handshake, Megaphone,
} from 'lucide-react';
...
const nav = [
  ...
  { href: '/creative', label: 'Creative', icon: Brush },
